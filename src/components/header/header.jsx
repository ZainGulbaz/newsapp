...
const Header = () => {
  ...
  return (
    <nav className='bg-gray-700 w-full'>
      ...
      <div className='text-primary p-6 shadow-xl flex justify-between item-center w-full'>
        ...
        <div className='hidden md:inline'>
          <Actions setIsOpen={setIsOpen} handleRefresh={handleRefresh}/>
        </div>
      ...
      {(displayMobileMenu) && <div className='p-2 transition-transform duration-300 ease-in-out transform'>
        <Actions className={"!flex-col !justify-start !items-start !gap-2"} setIsOpen={setIsOpen} handleRefresh={handleRefresh}/>
      </div>}
     
     <FilterModal modalIsOpen={isOpen} setIsOpen={setIsOpen} />
